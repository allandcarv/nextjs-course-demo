...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return insertOne; });
...
// EXTERNAL MODULE: ./shared/util/db.js
var db = __webpack_require__("KfxD");
...
async function getStaticPaths() {
  const meetups = await Object(db["a" /* find */])('meetups', '_id');
  return {
    fallback: false,
    paths: meetups.map(m => ({
      params: {
...
async function getStaticProps(context) {
  ...
  const selectedMeetup = await Object(db["b" /* findOne */])('meetups', {
    _id: params.meetupId
  });
  return {
    props: {
